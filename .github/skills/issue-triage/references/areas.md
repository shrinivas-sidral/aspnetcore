...
- Code: `src/Tools/`, `src/OpenApi/Microsoft.dotnet-openapi/`,
...
- Code: `src/Razor/`, shared UI content/assets under
  `src/ProjectTemplates/Web.ProjectTemplates/`, `src/Components/Forms/`,
  `src/Components/QuickGrid/`, `src/Components/CustomElements/`
